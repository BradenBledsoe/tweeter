...
import { userInfoActions, userInfoList } from "./UserInfoHooks";
import {
    UserInfoView,
    UserInfoPresenter,
...
interface Props {
    presenterFactory: (listener: UserInfoView) => UserInfoPresenter;
}
...
const UserInfo = (props: Props) => {
    ...
    const { currentUser, authToken, displayedUser } = userInfoList();
